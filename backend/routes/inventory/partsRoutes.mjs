// routes/inventory/partsRoutes.mjs
...
import {
  ...
  deactivate,
  destroy,
} from '../../controllers/inventory/partsController.mjs';
...
router.get('/by-sku/:sku', bySku);                    // company_id from JWT, sku in params
...
// --- Item mutations ---
router.patch('/:id', patch);                          // company_id from JWT + part_id param
